...
public class Craig extends Critter {
	...
	public static String runStats(java.util.List<Critter> craigs) {
		...
		stats += craigs.size() + " total Craigs    " + total_straight / (GENE_TOTAL * 0.01 * craigs.size()) + "% straight   ";
		stats += total_back / (GENE_TOTAL * 0.01 * craigs.size()) + "% back   " + total_right / (GENE_TOTAL * 0.01 * craigs.size()) + "% right   ";
